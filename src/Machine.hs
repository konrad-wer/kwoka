...
eval :: MExpr -> RuntimeEnv -> Stack -> MetaStack -> MValue
...
stack :: Stack -> MValue -> MetaStack -> MValue
...
action :: (MVar, MVar) -> Stack -> MetaStack -> MValue -> MetaStack -> MValue
